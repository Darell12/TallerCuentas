<div class="container  mt-4 shadow rounded-4">
  ...
  <div>
    <a href="<?php echo base_url('/ver_munis'); ?>"><button class="btn btn-outline-primary"><i class="bi bi-arrow-return-left"></i> Regresar</button></a>
  </div>
        ...
        <?php } else { ?>
          <?php foreach ($datos as $x => $valor) { ?>
            <tr>
              ...
              <th class="text-center"><?php echo $valor['estado'] == 'E' ? '<span class="text-danger">  Inactivo</span>' : '<span class="text-success"> Activo </span>'; ?></th>
              <th class="grid grid text-center" colspan="2">
                <button class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-href="<?php echo base_url('/estado_munis') . '/' . $valor['id'] . '/' . 'A'; ?>" title="Restaurar"><i class="bi bi-arrow-clockwise"></i></button>
              </th>
