...
<div class="container card my-4">
    ...
    <div class="table-responsive">
        <table class="table table-borderless table-sm table-striped" id="tablePaises" width="100%" cellspacing="0">
            <thead>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" pattern="[0-9]{4}" name="codigo">
          </div>
